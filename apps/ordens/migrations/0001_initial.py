    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalhe_servico', models.TextField(blank=True, null=True, verbose_name='Detalhes do Serviço')),
                ('data_execucao', models.DateField(blank=True, null=True, verbose_name='Data de Execução')),
                ('status_servico', models.CharField(blank=True, choices=[('em_andamento', 'Em Andamento'), ('resolvido', 'Resolvido'), ('respondido', 'Respondido')], max_length=15, null=True, verbose_name='Status do Serviço')),
                ('observacao', models.TextField(blank=True, null=True, verbose_name='Observações')),
                ('solicitacoes', models.ManyToManyField(blank=True, related_name='ordem_servico', to='solicitacoes.solicitacao', verbose_name='Solicitações')),
            ],
            options={
